        ...
        <Layout className='pt-0'>
          <div className='flex items-center justify-between w-full'>
            <div className='w-1/2'>
              ...
              <Image src={profilePic} alt="ProfilePhoto" className='w-full h-auto' />
            ...
            <h1 className="text-6xl text-left">
              ...
              <div className='flex items-center self-start mt-2'>
                ...
                className='ml-4 text-lg font-medium capitilize text-dark border-b-2 border-b-primary hover:border-b-primary'>Contact</Link>
              </div>
            </div>
          </div>
        </Layout>
